...
struct : public core::Renderer {
    const char * name() const noexcept override { return "2.1:0.2"; }
...
struct : public core::Renderer {
    const char * name() const noexcept override { return "2.1:0.3"; }
    bool captureCamera() const noexcept override { return true; }
...
struct : public core::Renderer {
    const char * name() const noexcept override { return "2.1:1"; }
    bool captureCamera() const noexcept override { return true; }
...
struct : public core::Renderer {
    const char * name() const noexcept override { return "2.1:4"; }
    bool captureCamera() const noexcept override { return true; }
